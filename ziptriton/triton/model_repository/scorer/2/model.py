...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        encoder_config = pb_utils.get_input_config_by_name(
            model_config, "adapter_out") # adapter_out
    ...
    def forward_adapter(self, encoder_out):
        ...
        # # Convert pb_utils.Tensor to a torch.Tensor.
        # if not isinstance(encoder_out, torch.Tensor):
        #     try:
        #         # Try to convert using as_numpy() if it's on CPU.
        #         encoder_out = torch.from_numpy(encoder_out.as_numpy())
        #     except Exception as e:
        #         # Fallback to DLPack conversion if the tensor is on GPU.
        #         logger.debug("as_numpy() conversion failed; converting via DLPack")
        #         encoder_out = torch.utils.dlpack.from_dlpack(encoder_out.to_dlpack())
        
        in_adapter_tensor = pb_utils.Tensor("encoder_out", encoder_out.cpu().numpy())
    ...
    def forward_joiner(self, cur_encoder_out, decoder_out):
        ...
        in_joiner_tensor_0 = pb_utils.Tensor("adapter_out", cur_encoder_out.cpu().numpy()) #encoder_out
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            in_0 = pb_utils.get_input_tensor_by_name(request, "adapter_out")
